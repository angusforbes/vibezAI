...
- **Search sections reordered** — results are shown as Playlists, then Albums, then Library (tracks you own), then catalog Tracks, five items per section, so the narrow column stays scannable.
